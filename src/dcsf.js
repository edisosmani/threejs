...
// Definieren der Szene und Kamera
const scene = new THREE.Scene();
const camera = new THREE.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 0.1, 1000);

// Erstellung der OrbitControls
...
scene.add(box);
const planeGeometry = new THREE.PlaneGeometry(30, 30, 100, 100); // Adjust segments as needed for the heightmap
...
const generateColorfulHeightmap = (width, height) => {
    ...
    // Create a gradient from black to white representing elevation
...
// Create a colorful heightmap texture
...
// Function to generate a colorful heightmap texture
...
const options = {
    sphereColor: '#ffea00', wireframe: false, speed: 0.01, angle: 0.2, intensity: 1
};
